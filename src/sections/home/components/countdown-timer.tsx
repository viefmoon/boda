        ...
        <div className="bg-card-bg rounded-2xl p-6 md:p-8 shadow-lg border border-card-border text-center">
          ...
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 md:gap-4">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-sm sm:text-base md:text-lg text-text-primary dark:text-white">días</span>
            </div>
            
            <span className="text-text-primary dark:text-white text-base sm:text-lg">:</span>
            ...
            <div className="flex items-baseline gap-0.5 sm:gap-1">
              ...
              <span className="text-xs sm:text-sm md:text-base text-text-primary dark:text-white">h</span>
            </div>
            ...
            <div className="flex items-baseline gap-0.5 sm:gap-1">
              ...
              <span className="text-xs sm:text-sm md:text-base text-text-primary dark:text-white">m</span>
            </div>
            ...
            <div className="flex items-baseline gap-0.5 sm:gap-1">
              ...
              <span className="text-xs sm:text-sm md:text-base text-text-primary dark:text-white">s</span>
            </div>
          </div>
          
          <p className="text-base text-text-primary dark:text-white mt-4">El gran día se acerca</p>
        </div>
      </motion.div>
    </div>
  );
