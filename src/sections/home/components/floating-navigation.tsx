...
export default function FloatingNavigation({
  ...
  return (
    ...
    >
      <motion.div
        whileHover={{ y: -2 }}
        className="bg-white/90 dark:bg-card-bg/90 backdrop-blur-md rounded-full px-2 sm:px-3 py-2 sm:py-2.5 shadow-lg dark:shadow-2xl border border-border-light dark:border-card-border hover:bg-white dark:hover:bg-card-bg hover:shadow-xl dark:hover:shadow-2xl transition-all duration-300"
      >
