    ...
    <div ref={ref} className="py-8 px-4 bg-background dark:bg-background">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-text-primary dark:text-white mt-3 max-w-xl mx-auto font-light">
            ...
            >
              ...
              <div className="space-y-1 pl-11">
                {padrino.personas.map((persona, personaIndex) => (
                  <p key={personaIndex} className="text-sm text-text-primary dark:text-white">
                    {persona}
                  </p>
                ))}
              </div>
        ...
        >
          <div className="bg-card-bg/50 backdrop-blur-sm rounded-xl p-4 max-w-2xl mx-auto border border-card-border">
            <p className="text-stone-900 dark:text-white text-sm italic font-light">
